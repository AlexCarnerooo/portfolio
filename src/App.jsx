  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-[#1a1a2e] to-gray-900">
      ...
      <nav className="container mx-auto px-4 py-6 flex justify-between items-center">
        <div className="text-secondary font-mono text-xl">&lt;AC /&gt;</div>
      ...
      <section className="container mx-auto px-4 py-20 flex items-center justify-between">
        <div className="max-w-2xl">
          <h2 className="text-secondary text-2xl mb-4">Hola, soy</h2>
          <h1 className="text-white text-6xl font-bold mb-4">Alex<br/>Carneroo</h1>
          <h3 className="text-secondary text-3xl mb-6">Frontend Developer</h3>
        ...
        <div className="relative">
          ...
          <div className="w-96 h-96 bg-white rounded-full relative overflow-hidden">
            {/* Aquí irá tu foto con un fondo estilizado */}
